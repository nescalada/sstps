...
if(num_custs_arrivals > 1)
	mrc(num_custs_arrivals) = asimilar_media(mrc(num_custs_arrivals-1),max(queue_departure_time - arrival_time(1:queue_departure_time_len)), num_custs_arrivals-1);
else
...
if (len > 0)
	...
	if (num_custs_arrivals > 1)
		prop_rs(num_custs_arrivals) = asimilar_media(prop_rs(num_custs_arrivals-1), cant/len, num_custs_arrivals - 1);
	else
