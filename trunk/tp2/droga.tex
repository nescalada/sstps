...
El modelo de compartimentos que utilizamos lo mostramos en la figura 1. 
\begin{figure}[t]
\label{fig:grafico_k}
\begin{center}
%\centering
...
\caption{$ V_{1}$ representa el volumen de sangre. $V_{2} $ representa el vol\'umen del \'organo.  }
\end{center}
\end{figure}
...
\bibitem{IEEEhowto:kopka}
 Wagner, John G. \emph{Farmacocin\'etica cl\'inica.}
