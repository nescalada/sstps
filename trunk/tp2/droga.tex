...
como una droga se distribuye en el organ\'ismo, y los procesos a los que el f\'armaco es sometido a trav\'es de su
paso por el mismo.\\
\indent Nosotros modelamos la din\'amica de una sustancia, mediante un modelo de dos compartimentos, 
los cuales uno cumple el rol de la sangre en el organ\'ismo, y el otro compartimento representa un \'organo cualquiera 
...
\indent Tras una serie de simulaciones expermientales logramos establecer los par\'ametros mas adecuados para lograr
...
\indent La dosis de flujo de sustancia esta dada por las ecuaciones diferenciales x1 y x2. donde $c_{1}1$ es la concentraci\'on de la sustancia 
en sangre. $c_{2}$ representa la concentraci\'on de la sustancia en el \'organo. 
\begin{align}
...
\end{align}
Expresamos el sistema de ecuaciones diferenciales de (3) y (4) como un sistema lineal $ \dot{x} = Ax + bu$ expresado en (5) 
...
\section{Estabilidad del modelo}
 ( aca habria que sacar los autovalores y autovectores y explicar que el modelo es estable y poner algun grafico)
...
(aca habria que ir cambiando K y explicar cual K es el adecuado para controlar el sistema )
