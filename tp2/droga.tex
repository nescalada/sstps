...
Para analizar la estabilidad del modelo propuesto, se calculan los autovalores asociados a la matriz del sistema ($A$).
\begin{equation}
\label{eqn:autovalores1}
	...
	\bigg\vert
\end{equation}
Calculando el m\'odulo se obtiene la ecuaci\'on \ref{eq:autovalores2}, y se iguala a cero
