...
% Corre la simulacion
while ( num_custs_delayed < num_delays_required + 1)
	...
	switch (next_event_type)
		case 1
			...
			num_arrivals++;
			if (num_arrivals == 10)
				save ../../datos_parte1/time_p2 time;
			end
...
save ../../datos_parte1/times times;
save ../../datos_parte1/queue_len queue_len;

%l = l(1:100);
%q = q(1:100);
%b = b(1:100);
save ../../datos_parte1/l l;
save ../../datos_parte1/q q;
save ../../datos_parte1/b b;
save ../../datos_parte1/time_arrivals time_arrivals;

save ../../datos_parte1/arrival_time arrival_time;
save ../../datos_parte1/queue_departure_time queue_departure_time;
save ../../datos_parte1/system_departure_time system_departure_time;

aux = arrival_time(1:num_delays_required);
save../../datos_parte1/arrival_time aux;
aux = queue_departure_time(1:num_delays_required);
save../../datos_parte1/queue_departure_time aux;
aux = system_departure_time(1:num_delays_required);
save../../datos_parte1/system_departure_time aux;
